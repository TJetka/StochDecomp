...
R = [
     ...
     [ (p(3)*y(3) - p(4)*y(13)) ];
     [ (p(8) - p(9)*y(17)) ];
     [ (4*p(4)*y(46) + exp(y(17) - p(8)/p(9))*p(1)*y(1)*JAKSTAT_stimulus(t) - 2*exp(y(17) - p(8)/p(9))*p(1)*y(18)*JAKSTAT_stimulus(t) - 2*exp(y(17) - p(8)/p(9))*p(1)*y(1)*y(50)*JAKSTAT_stimulus(t)) ];
     [ (exp(y(17) - p(8)/p(9))*p(1)*y(1)*JAKSTAT_stimulus(t) - 8*p(2)*y(2)*y(19) + 2*exp(y(17) - p(8)/p(9))*p(1)*y(35)*JAKSTAT_stimulus(t) + 2*exp(y(17) - p(8)/p(9))*p(1)*y(1)*y(65)*JAKSTAT_stimulus(t)) ];
     [ (4*p(2)*y(2)*y(51) - 2*p(3)*y(20)) ];
     [ (2*p(3)*y(66) - 2*p(4)*y(21)) ];
     [ (2*p(4)*y(80) - 2*p(4)*y(22)) ];
     ...
     [ (2*exp(y(17) - p(8)/p(9))*p(1)*p(6)*y(47)*JAKSTAT_stimulus(t) - 4*p(3)*p(6)*y(76) + exp(y(17) - p(8)/p(9))*p(1)*p(6)^2*y(1)*JAKSTAT_stimulus(t) + 2*exp(y(17) - p(8)/p(9))*p(1)*p(6)*y(1)*y(167)*JAKSTAT_stimulus(t)) ];
