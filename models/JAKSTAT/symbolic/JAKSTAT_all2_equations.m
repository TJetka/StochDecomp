...
R = [
     ...
     [ (4*p(2)*y(2)^2 - 8*p(2)*y(2)*y(19) + 2*exp(y(17) - p(8)/p(9))*p(1)*y(35)*JAKSTAT_stimulus(t) + 2*exp(y(17) - p(8)/p(9))*p(1)*y(1)*y(65)*JAKSTAT_stimulus(t)) ];
     [ (p(2)*y(2)^2 - 2*p(3)*y(20) + 4*p(2)*y(2)*y(51)) ];
