...
R = [
     ...
     [ (p(3)*y(3) - 2*p(3)*y(20) + 4*p(2)*y(2)*y(51)) ];
     [ (p(3)*y(3) - 2*p(4)*y(21) + 2*p(3)*y(66)) ];
     ...
     [ (4*p(3)*p(6)^2*y(3) - 4*p(3)*p(6)*y(76) + 2*exp(y(17) - p(8)/p(9))*p(1)*p(6)*y(47)*JAKSTAT_stimulus(t) + 2*exp(y(17) - p(8)/p(9))*p(1)*p(6)*y(1)*y(167)*JAKSTAT_stimulus(t)) ];
     [ (4*p(3)*p(7)^2*y(3) - 4*p(3)*p(7)*y(77) + 4*p(4)*p(7)*y(162)) ];
     [ (p(3)*y(3) + 2*p(3)*y(78) - 2*p(4)*y(163)) ];
     [ (-2*p(9)*y(34)) ];
     ...
     [ (p(3)*y(77) - p(4)*y(162) - 2*p(3)*p(7)*y(3) - 2*p(3)*p(7)*y(78) + 2*p(4)*p(7)*y(163)) ];
