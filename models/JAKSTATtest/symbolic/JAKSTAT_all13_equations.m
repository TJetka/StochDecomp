...
R = [
     ...
     [ (p(3)*y(3) - p(4)*y(13)) ];
     [ (p(8) - p(9)*y(17)) ];
     [ (4*p(4)*y(13) + 4*p(4)*y(46) - 2*exp(y(17) - p(8)/p(9))*p(1)*y(18)*JAKSTAT_stimulus(t) - 2*exp(y(17) - p(8)/p(9))*p(1)*y(1)*y(50)*JAKSTAT_stimulus(t)) ];
     ...
     [ (p(4)*y(13) - 2*p(4)*y(30) + 2*p(4)*y(156)) ];
     ...
     [ (4*p(4)*p(7)^2*y(13) - 4*p(3)*p(7)*y(77) + 4*p(4)*p(7)*y(162)) ];
     [ (p(4)*y(13) + 2*p(3)*y(78) - 2*p(4)*y(163)) ];
     [ (-2*p(9)*y(34)) ];
     ...
     [ (p(3)*y(77) - p(4)*y(162) - 2*p(4)*p(7)*y(13) - 2*p(3)*p(7)*y(78) + 2*p(4)*p(7)*y(163)) ];
