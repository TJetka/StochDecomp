...
R = [
     ...
     [ (p(3)*y(3) - p(4)*y(13)) ];
     [ (p(8) - p(9)*y(17)) ];
     [ (4*p(4)*y(13) + 4*p(4)*y(46) + exp(y(17) - p(8)/p(9))*p(1)*y(1)*JAKSTAT_stimulus(t) - 2*exp(y(17) - p(8)/p(9))*p(1)*y(18)*JAKSTAT_stimulus(t) - 2*exp(y(17) - p(8)/p(9))*p(1)*y(1)*y(50)*JAKSTAT_stimulus(t)) ];
     [ (4*p(2)*y(2)^2 - 8*p(2)*y(2)*y(19) + exp(y(17) - p(8)/p(9))*p(1)*y(1)*JAKSTAT_stimulus(t) + 2*exp(y(17) - p(8)/p(9))*p(1)*y(35)*JAKSTAT_stimulus(t) + 2*exp(y(17) - p(8)/p(9))*p(1)*y(1)*y(65)*JAKSTAT_stimulus(t)) ];
     ...
     [ (4*p(3)*p(6)^2*y(3) - 4*p(3)*p(6)*y(76) + 2*exp(y(17) - p(8)/p(9))*p(1)*p(6)*y(47)*JAKSTAT_stimulus(t) + exp(y(17) - p(8)/p(9))*p(1)*p(6)^2*y(1)*JAKSTAT_stimulus(t) + 2*exp(y(17) - p(8)/p(9))*p(1)*p(6)*y(1)*y(167)*JAKSTAT_stimulus(t)) ];
     [ (4*p(3)*p(7)^2*y(3) + 4*p(4)*p(7)^2*y(13) - 4*p(3)*p(7)*y(77) + 4*p(4)*p(7)*y(162)) ];
     [ (p(3)*y(3) + p(4)*y(13) + 2*p(3)*y(78) - 2*p(4)*y(163)) ];
     [ (p(8) + p(9)*y(17) - 2*p(9)*y(34)) ];
     [ (2*p(4)*y(61) - 4*p(2)*y(2)*y(35) - exp(y(17) - p(8)/p(9))*p(1)*y(1)*JAKSTAT_stimulus(t) + exp(y(17) - p(8)/p(9))*p(1)*y(18)*JAKSTAT_stimulus(t) - exp(y(17) - p(8)/p(9))*p(1)*y(35)*JAKSTAT_stimulus(t) + exp(y(17) - p(8)/p(9))*p(1)*y(1)*y(50)*JAKSTAT_stimulus(t) - exp(y(17) - p(8)/p(9))*p(1)*y(1)*y(65)*JAKSTAT_stimulus(t)) ];
     ...
     [ (2*p(4)*y(30) - 2*p(4)*y(13) + p(4)*y(45) - p(4)*y(46) - exp(y(17) - p(8)/p(9))*p(1)*y(46)*JAKSTAT_stimulus(t) - exp(y(17) - p(8)/p(9))*p(1)*y(1)*y(164)*JAKSTAT_stimulus(t)) ];
     [ (2*p(4)*y(161) - 2*p(3)*p(6)*y(36) - exp(y(17) - p(8)/p(9))*p(1)*y(47)*JAKSTAT_stimulus(t) - exp(y(17) - p(8)/p(9))*p(1)*p(6)*y(1)*JAKSTAT_stimulus(t) + exp(y(17) - p(8)/p(9))*p(1)*p(6)*y(18)*JAKSTAT_stimulus(t) - exp(y(17) - p(8)/p(9))*p(1)*y(1)*y(167)*JAKSTAT_stimulus(t) + exp(y(17) - p(8)/p(9))*p(1)*p(6)*y(1)*y(50)*JAKSTAT_stimulus(t)) ];
     [ (2*p(4)*y(162) + 4*p(4)*p(7)*y(13) - 2*p(3)*p(7)*y(36) + 2*p(4)*p(7)*y(46) - exp(y(17) - p(8)/p(9))*p(1)*y(48)*JAKSTAT_stimulus(t) - exp(y(17) - p(8)/p(9))*p(1)*y(1)*y(169)*JAKSTAT_stimulus(t)) ];
     [ (p(3)*y(36) - 2*p(4)*y(13) - p(4)*y(46) + 2*p(4)*y(163) - exp(y(17) - p(8)/p(9))*p(1)*y(49)*JAKSTAT_stimulus(t) - exp(y(17) - p(8)/p(9))*p(1)*y(1)*y(170)*JAKSTAT_stimulus(t)) ];
     [ (2*p(4)*y(164) - p(9)*y(50) - exp(y(17) - p(8)/p(9))*p(1)*y(50)*JAKSTAT_stimulus(t) - exp(y(17) - p(8)/p(9))*p(1)*y(1)*y(34)*JAKSTAT_stimulus(t)) ];
     [ (2*p(2)*y(2)*y(19) - 2*p(2)*y(2)^2 - p(3)*y(51) - 4*p(2)*y(2)*y(51) + exp(y(17) - p(8)/p(9))*p(1)*y(36)*JAKSTAT_stimulus(t) + exp(y(17) - p(8)/p(9))*p(1)*y(1)*y(79)*JAKSTAT_stimulus(t)) ];
     ...
     [ (exp(y(17) - p(8)/p(9))*p(1)*y(47)*JAKSTAT_stimulus(t) - 4*p(2)*y(2)*y(62) - 2*p(3)*p(6)*y(51) + exp(y(17) - p(8)/p(9))*p(1)*p(6)*y(1)*JAKSTAT_stimulus(t) + exp(y(17) - p(8)/p(9))*p(1)*p(6)*y(35)*JAKSTAT_stimulus(t) + exp(y(17) - p(8)/p(9))*p(1)*y(1)*y(167)*JAKSTAT_stimulus(t) + exp(y(17) - p(8)/p(9))*p(1)*p(6)*y(1)*y(65)*JAKSTAT_stimulus(t)) ];
     ...
     [ (2*p(3)*p(6)*y(3) - p(3)*y(76) - 2*p(3)*p(6)*y(20) + 2*p(2)*y(2)*y(62) + exp(y(17) - p(8)/p(9))*p(1)*p(6)*y(36)*JAKSTAT_stimulus(t) + exp(y(17) - p(8)/p(9))*p(1)*p(6)*y(1)*y(79)*JAKSTAT_stimulus(t)) ];
     [ (2*p(3)*p(7)*y(3) - p(3)*y(77) - 2*p(3)*p(7)*y(20) + 2*p(4)*p(7)*y(75) + 2*p(2)*y(2)*y(63)) ];
     [ (p(3)*y(20) - p(3)*y(3) - p(4)*y(75) - p(3)*y(78) + 2*p(2)*y(2)*y(64)) ];
     ...
     [ (p(3)*y(76) - p(4)*y(89) - 2*p(3)*p(6)*y(3) - 2*p(3)*p(6)*y(66) + exp(y(17) - p(8)/p(9))*p(1)*p(6)*y(37)*JAKSTAT_stimulus(t) + exp(y(17) - p(8)/p(9))*p(1)*p(6)*y(1)*y(92)*JAKSTAT_stimulus(t)) ];
     [ (p(3)*y(77) - p(4)*y(90) - 2*p(3)*p(7)*y(3) - 2*p(3)*p(7)*y(66) + 2*p(4)*p(7)*y(88)) ];
     [ (p(3)*y(3) + p(3)*y(66) + p(3)*y(78) - p(4)*y(88) - p(4)*y(91)) ];
     ...
     [ (p(4)*y(158) - p(4)*y(162) - 2*p(4)*p(7)*y(13) + 2*p(4)*p(7)*y(30) - 2*p(3)*p(7)*y(75)) ];
     [ (p(4)*y(13) - p(4)*y(30) + p(3)*y(75) + p(4)*y(159) - p(4)*y(163)) ];
     [ (p(4)*y(160) - p(4)*y(164) - p(9)*y(164)) ];
     [ (2*p(4)*p(7)*y(161) - 2*p(3)*p(7)*y(76) - 2*p(3)*p(6)*y(77) + 4*p(3)*p(6)*p(7)*y(3) + exp(y(17) - p(8)/p(9))*p(1)*p(6)*y(48)*JAKSTAT_stimulus(t) + exp(y(17) - p(8)/p(9))*p(1)*p(6)*y(1)*y(169)*JAKSTAT_stimulus(t)) ];
     [ (p(3)*y(76) - p(4)*y(161) - 2*p(3)*p(6)*y(3) - 2*p(3)*p(6)*y(78) + exp(y(17) - p(8)/p(9))*p(1)*p(6)*y(49)*JAKSTAT_stimulus(t) + exp(y(17) - p(8)/p(9))*p(1)*p(6)*y(1)*y(170)*JAKSTAT_stimulus(t)) ];
     ...
     [ (p(3)*y(77) - p(4)*y(162) - 2*p(3)*p(7)*y(3) - 2*p(4)*p(7)*y(13) - 2*p(3)*p(7)*y(78) + 2*p(4)*p(7)*y(163)) ];
